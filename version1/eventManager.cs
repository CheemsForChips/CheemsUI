public class EventManager{
    ...
    #region 传入选择的区块编号的委托
    public delegate void SelectedToString(int index,System.Drawing.Size clientSize);
    public SelectedToString CheemsStringDelegate  = null;
    public static void showSelectedAction(int index,System.Drawing.Size clientSize){
        // Label textLabel = new Label();
        // textLabel.Text = index.ToString();
        // textLabel.Font = new Font("微软雅黑", 20, FontStyle.Bold);

        // textLabel.AutoSize = true;
        // textLabel.Location = new Point(clientSize.Width / 2, clientSize.Height / 2);
